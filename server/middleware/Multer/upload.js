...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    else if (file.fieldname === "kycDocuments") folder += "docs/";
    else if (file.fieldname === "payoutProofImage") folder += "payouts/";
...
module.exports = {
  ...
  uploadPayoutProof: upload.single("payoutProofImage"),
